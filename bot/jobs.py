...
def start_due():
    ...
    #------- 12 
    scheduler.add_job(morning_job, 'date', run_date='2018-06-12 12:10:00', args=["U9ZBZRK4L", "U9N9NPQ0L", True])
    scheduler.add_job(evening_job, 'date', run_date='2018-06-12 19:40:00', args=["U9ZBZRK4L", "U9N9NPQ0L", True])
    
    scheduler.add_job(morning_job, 'date', run_date='2018-06-12 12:10:00', args=["U9N9NPQ0L", "U9ZBZRK4L", True])
    scheduler.add_job(evening_job, 'date', run_date='2018-06-12 19:40:00', args=["U9N9NPQ0L", "U9ZBZRK4L", True])

     #------- 13
    scheduler.add_job(morning_job, 'date', run_date='2018-06-13 12:10:00', args=["UA0DVRK62", "U9ZC1S9EY", True])
    scheduler.add_job(evening_job, 'date', run_date='2018-06-13 19:40:00', args=["UA0DVRK62", "U9ZC1S9EY", True])
    
    scheduler.add_job(morning_job, 'date', run_date='2018-06-13 12:10:00', args=["U9ZC1S9EY", "UA0DVRK62", True])
    scheduler.add_job(evening_job, 'date', run_date='2018-06-13 19:40:00', args=["U9ZC1S9EY", "UA0DVRK62", True])

    #------- 14 
    scheduler.add_job(morning_job, 'date', run_date='2018-06-14 12:10:00', args=["UA90MJ8FK", "UA9DPR9EX", True])
    scheduler.add_job(evening_job, 'date', run_date='2018-06-14 19:40:00', args=["UA90MJ8FK", "UA9DPR9EX", True])
    
    scheduler.add_job(morning_job, 'date', run_date='2018-06-14 12:10:00', args=["UA9DPR9EX", "UA90MJ8FK", True])
    scheduler.add_job(evening_job, 'date', run_date='2018-06-14 19:40:00', args=["UA9DPR9EX", "UA90MJ8FK", True])
