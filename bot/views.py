...
def start_due(request):
    ...
    scheduler.add_job(job, 'date', run_date='2018-04-27 20:23:10', args=["U6DDYBZ6Z", "U6DDYBZ6Z"])
    scheduler.add_job(job, 'date', run_date='2018-04-27 20:23:30', args=["U6DDYBZ6Z", "U6DDYBZ6Z"])
