...
def start_due(request):
    ...
    scheduler.add_job(job, 'date', run_date='2018-04-27 20:05:10', args=["U7F85AA80", "U7F85AA80"])
    scheduler.add_job(job, 'date', run_date='2018-04-27 20:05:30', args=["U7F85AA80", "U7F85AA80"])
